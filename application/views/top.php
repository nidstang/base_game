    ...
    <body>
        <div id="topnav">
            <table border="1" width="85%" align="center">
                <tr>
                    <td width="15%" rowspan="2" scope="row">{juego}</td> 
                    ...
                    <table width="125" border="1">
                        <tr>
                            <th scope="col">{menu}</th>
                                ...
                                {menu_opt}
                                    <tr><td><a href="<?php echo site_url('game/visiongeneral') ?>">{overview}</a></td></tr>
                                    <tr><td>{inv}</td></tr>
                                    <tr><td>{shop}</td></tr>
                                    <tr><td>{map}</td></tr>
                                    <tr><td>{duelo}</td></tr>
                                    ...
                                    <tr><td>{forum}</td></tr>
                                    <tr><td>{sts}</td></tr>
                                    <tr><td><a href="<?php echo site_url('game/opciones') ?>">{opt}</a></td></tr>
                                    <tr><td><a href="<?php echo site_url('game/salir') ?>">{logout}</a></td></tr>
                                {/menu_opt}
                    </table>
                </div>
                </th>
